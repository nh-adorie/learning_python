...
# đọc file starting_letter ==> lưu nội dung từ file vào biến "letter_template"
with open(letter_path) as letter_file:
    letter_template = letter_file.read()

# đọc file invited_names ==> lưu nội dung từ file vào biến "names_list"
...
for name in names_list: # vì names_list là list nên có thể lặp như này
    replace_name = name.strip()
    personized_letter = letter_template.replace("[name]", replace_name) # thay thế [name] thành tên trong list đó
